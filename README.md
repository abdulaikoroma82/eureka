...
> This README is the complete reference. Prefer bite-size pages? The same
> content is split by topic under [`docs/`](#documentation).

## How the AI is used — two distinct roles

The model is used in two roles with **opposite requirements**. This is the one
...
- [How the AI is used — two distinct roles](#how-the-ai-is-used--two-distinct-roles)
- [Why it exists](#why-it-exists)
- [Architecture](#architecture)
- [Installation](#installation)
- [Usage](#usage)
- [Input formats](#input-formats)
- [Reviewing the AI draft](#reviewing-the-ai-draft)
- [What the deterministic layer does](#what-the-deterministic-layer-does)
- [AI authoring & enrichment](#ai-authoring--enrichment)
- [Validation & deployment compatibility](#validation--deployment-compatibility)
- [Survey Design Score (methodology intelligence)](#survey-design-score-methodology-intelligence)
...
- [Testing](#testing)
- [Packaging as a Windows application](#packaging-as-a-windows-application)
...
(authoring is AI-first — see [the two AI roles](#how-the-ai-is-used--two-distinct-roles)).

```bash
git clone <repo-url>
cd eureka
python -m venv .venv && source .venv/bin/activate    # Windows: .venv\Scripts\activate
pip install -r requirements.txt          # or:  pip install -e .  (adds the `xlsform-studio` command)
...
* **`platforms.yaml`** — the deployment-target profiles (column dialects,
  ...
  See [Platform-specific standards](#platform-specific-standards).
* **`design_intelligence.yaml`** — the survey-methodology vocabularies behind
  the [Survey Design Score](#survey-design-score-methodology-intelligence):
...
This README is the full reference. The same material, split by topic:
