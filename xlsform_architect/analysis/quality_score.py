...
the numbers (:mod:`xlsform_architect.ai.narrative`) but never moves them.
...
Inputs
------
A compiled :class:`~xlsform_architect.models.Questionnaire` and its
:class:`~xlsform_architect.validation.report_generator.ValidationReport`.
...
>>> from xlsform_architect.validation.report_generator import ValidationReport
