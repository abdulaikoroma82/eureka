...
/ ``.csv`` and build a :class:`~xlsform_architect.models.Questionnaire`.
...
class ExcelParser:
    ...
    def _from_xlsform(self, sheets: Dict[str, pd.DataFrame]) -> Questionnaire:
        ...
        for _, row in survey.iterrows():
            ...
            if not qtype or qtype in ("begin group", "end group",
            ...
            q = Question(
                ...
                constraint_message=str(row.get("constraint_message", "")).strip(),
