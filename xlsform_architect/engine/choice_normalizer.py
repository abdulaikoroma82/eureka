...
:class:`~xlsform_architect.validation.consistency_validator.
ConsistencyValidator` flags those as near-identical for a human instead.

Inputs
------
A compiled :class:`~xlsform_architect.models.Questionnaire` (mutated in
place).
...
Example
-------
>>> from xlsform_architect.models import (Choice, ChoiceList, Question,
...                                       Questionnaire)
>>> qn = Questionnaire(
